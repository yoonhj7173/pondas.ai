...
const AGENT: AgentPanelData = {
  ...
  current_task_id: "task-1", awaiting_prompt: "Which database should I assume — Postgres or SQLite?", error_summary: null, failed_task_id: null,
...
export default function PanelsPreview() {
  ...
  return (
    <div className="relative h-screen w-screen" style={{ background: "#C6C9BC" }}>
      ...
      {view === "agent" && <AgentPanel data={AGENT} onClose={() => {}} onStop={() => {}} onRemove={() => {}} onProvideInput={() => {}} onRetry={() => {}} />}
